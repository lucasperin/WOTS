...
TEST(ConstantSumWots_test, constructor_256_34_2832_C) {
	ASSERT_EXIT(
	{
...
TEST(ConstantSumWots_test, load_private_key_256_34_2832_C) {
	ASSERT_EXIT( {
	CWOTS_SHA256_34_2832 w;
	w.loadPrivateKey();
	exit(0);
...
TEST(ConstantSumWots_test, load_keys_256_34_2832_C) {
	ASSERT_EXIT( {
	CWOTS_SHA256_34_2832 w;
	w.loadKeys();
	exit(0);
