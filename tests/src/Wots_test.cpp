...
TEST(ClassicWots_test, constructor_OpenSSLSha256) {
	ASSERT_EXIT( {
	{ClassicWots<OpenSSLSha256> wots;} 
	exit(0);
...
TEST(ClassicWots_test, constructor_OpenSSLSha512) {
	ASSERT_EXIT( {
	{ClassicWots<OpenSSLSha512> wots;} 
	exit(0);
	},::testing::ExitedWithCode(0),".*");
}

TEST(ClassicWots_test, params_4_OpenSSLSha256) {
	ClassicWots<OpenSSLSha256> wots(4);
	ASSERT_EQ(wots.n(),  32);
	ASSERT_EQ(wots.w(),  2);
...
TEST(ClassicWots_test, params_16_OpenSSLSha256) {
	ClassicWots<OpenSSLSha256> wots(16);
	ASSERT_EQ(wots.n(),  32);
	ASSERT_EQ(wots.w(),  4);
	ASSERT_EQ(wots.t(),  67);
...
TEST(ClassicWots_test, params_default_OpenSSLSha256) {
	ClassicWots<OpenSSLSha256> wots;
	ASSERT_EQ(wots.n(),  32);
	ASSERT_EQ(wots.w(),  4);
	ASSERT_EQ(wots.t(),  67);
...
TEST(ClassicWots_test, params_256_OpenSSLSha256) {
	ClassicWots<OpenSSLSha256> wots(256);
	ASSERT_EQ(wots.n(),  32);
	ASSERT_EQ(wots.w(),  8);
	ASSERT_EQ(wots.t(),  34);
...
TEST(ClassicWots_test, params_65536_OpenSSLSha256) {
	ClassicWots<OpenSSLSha256> wots(65536);
	ASSERT_EQ(wots.n(),  32);
	ASSERT_EQ(wots.w(),  16);
	ASSERT_EQ(wots.t(),  18);
...
TEST(ClassicWots_test, params_any_OpenSSLSha256) {
	ClassicWots<OpenSSLSha256> wots(777);
	ASSERT_EQ(wots.n(),  32);
	ASSERT_EQ(wots.w(),  16);
	ASSERT_EQ(wots.t(),  18);
	ASSERT_EQ(wots.t1(), 16);
...
TEST(ClassicWots_test, load_private_key_OpenSSLSha256) {
	ASSERT_EXIT( {
	ClassicWots<OpenSSLSha256> wots(777);
	wots.loadPrivateKey();
	exit(0);
...
TEST(ClassicWots_test, load_keys_65536_OpenSSLSha256) {
	ASSERT_EXIT( {
	ClassicWots<OpenSSLSha256> wots(777);
	wots.loadKeys();
	exit(0);
...
TEST(ClassicWots_test, print_key) {
	ClassicWots<OpenSSLSha256> wots(777);
	wots.loadKeys();
